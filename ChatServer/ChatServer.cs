...
namespace Mikejzx.ChatServer
{
    public class ChatServer
    {
        ...
        public void Run(string certificatePath)
        {
            ...
            // Yêu cầu nhập password cho chứng chỉ
            Console.Write("Please enter the password for the certificate: ");
            string password = Console.ReadLine(); // Nhập password từ người dùng
